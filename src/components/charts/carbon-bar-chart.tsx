...
export function CarbonBarChart({ data, comparison = false }: { data: CarbonPoint[]; comparison?: boolean }) {
  return (
    <div className="h-72 w-full" role="img" aria-label="Grafik emisi karbon dalam kilogram CO2e">
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={data} margin={{ top: 8, right: 8, left: -20, bottom: 0 }} barGap={4}>
          ...
          <YAxis axisLine={false} tickLine={false} tick={{ fill: "#64748b", fontSize: 11 }} unit=" kg" />
